function [w_hat, cdiag, hypers_estimation, w_dif, sq_er] = runDRD(prs0,datastruct,lb,ub,iters,init_bound,truth)
...
for iter = 2:iters
    ...
    % lbfgs
    fun = @(var) obj_v_dual(var, datastruct, bp, kdiag, G, opt);
