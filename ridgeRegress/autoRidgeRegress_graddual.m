function [kest,stats] = autoRidgeRegress_graddual(dd,hprnge)
% Automatic ridge regression using gradient and Hessian in dual space
%
% [kest,stats] = autoRidgeRegress_graddual(sdat,hprnge)
%
...
% HessCheck(lfun, hprs0);  % check entire Hessian -- works!
